...
from src.utils.parser_utils import get_cond_mode
from data.humanml_utils import HML_EE_JOINT_NAMES

def load_model_wo_clip(model, state_dict):
    del state_dict['sequence_pos_encoder.pe']
    del state_dict['embed_timestep.sequence_pose_encoder.pe']
...
def create_gaussian_diffusion(args):
    ...
    model_var_type = ((gd.ModelVarType.FIXED_LARGE if not args.sigma_small else gd.ModelVarType.FIXED_SMALL) if not learn_sigma else gd.ModelVarType.LEARNED_RANGE),
